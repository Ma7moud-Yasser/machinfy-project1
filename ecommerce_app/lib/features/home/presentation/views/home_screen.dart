                        ...
                        child: Stack(
                          children: [
                            Positioned(
                              ...
                              child: Container(
                                padding:
                                    PaddingManager.smallSymmetricHorizontal(
                                      context,
                                    ).copyWith(
                                      top:
                                          SizeManager.getSize(context).height *
                                          0.008,
                                    ),
                                decoration: BoxDecoration(
                                  color: AppColor.lightGrey,
                            ...
                            Positioned(
                              ...
                              child: IconButton(
                                ...
                                icon: Icon(
                                  ...
                                  size:
                                      SizeManager.getSize(context).width * 0.06,
                                ),
                              ),
                            ),
                            Positioned(
                              ...
                              child: Container(
                                ...
                                width:
                                    SizeManager.getSize(context).width * 0.44,
                                padding:
                                    PaddingManager.smallSymmetricHorizontal(
                                      context,
                                    ),
